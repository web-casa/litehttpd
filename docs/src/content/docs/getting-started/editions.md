...
| **Install on** | Stock (unmodified) OLS | Custom-built OLS with 4 patches |
| **Install time** | 1 minute (copy .so) | 10-15 minutes (compile OLS) |
| **OLS binary** | Unchanged | Replaced with patched version |
