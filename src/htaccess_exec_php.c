...
{
    (void)session; (void)dir;
    /* H7: php_admin_value is not allowed in .htaccess for security.
     * It could override disable_functions, open_basedir, etc. */
    return 0;
}
...
{
    (void)session; (void)dir;
    /* H7: php_admin_flag is not allowed in .htaccess for security.
     * It could override disable_functions, open_basedir, etc. */
    return 0;
}
