...
为 OpenLiteSpeed 提供完整的 Apache .htaccess 兼容支持。83 种指令类型，100% WordPress 兼容，静态文件性能比 Apache 快 2.5 倍。
...
- **83 种 .htaccess 指令类型** — Header、Redirect、RewriteRule/RewriteCond、SetEnv、Expires、php_value/php_flag、Options、Require、AuthType Basic、DirectoryIndex、FilesMatch 等
...
LiteHTTPD 支持 **83 种指令类型**，CyberPanel 约 29 种。CyberPanel 的所有功能均已覆盖，并提供更多能力，包括 RewriteRule 执行、If/ElseIf/Else 条件块、ap_expr 引擎、Require 指令、AuthType Basic、Options、AllowOverride 和 readApacheConf。
